...
```
git clone https://gitflic.ru/project/gnida200/scbt-summer-practice-2025.git
cd scbt-summer-practice-2025
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/gnida200/scbt-summer-practice-2025.git
git clone
